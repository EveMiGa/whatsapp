...
$sql="update contacto set nombre_suc='$nombre', direccion='$direccion', email='$email', tel='$tel', cel='$cel', 
whatsapp='$whatsapp' where id_contacto='$id'";
...
location.href='administrar.php';
    ...
    echo "<script>
    alert('El contacto no se pudo actualizar correctamente');
    </script>";
}
}
?>
...
<body>
    <br>
    <h3><a href="administrar.php">Contactos->Administrar Contactos</a></h3>
    <center>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            <table border="1">
                ...
                <tr>
                    ...
                    <td><input type="text" name="email" value="<?php echo $fila['email']?>" require></td>    
                </tr>
                <tr>
